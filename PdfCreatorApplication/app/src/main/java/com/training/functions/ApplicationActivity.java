...
public class ApplicationActivity extends AppCompatActivity {
    ...
    private Button btn_saveChart, btn_byDate, btn_byWeek, btn_byMonth;
    private TextView tv_x_axis_reportdate, tv_wallLength;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_saveChart = (Button) findViewById(R.id.btn_saveChart);
        btn_byDate = (Button) findViewById(R.id.btn_byDate);
        btn_byWeek = (Button) findViewById(R.id.btn_byWeek);
        btn_byMonth = (Button) findViewById(R.id.btn_byMonth);
        tv_x_axis_reportdate = (TextView) findViewById(R.id.tv_x_axis_reportdate);
        tv_wallLength = (TextView) findViewById(R.id.tv_wallLength);
        ...
        btn_saveChart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String xAxisTitle = tv_x_axis_reportdate.getText().toString();
                String yAxisTitle = tv_wallLength.getText().toString();
                configureDataTable();
                ExportChartAsyncTask exportChartAsyncTask = new ExportChartAsyncTask(ApplicationActivity.this, lineChart.getChartBitmap(), xAxisTitle, yAxisTitle, noOfCols, noOfRows, colHeadings, dataTable);
    ...
    private void setBasicLineChartProperties(int dataSetSize) {
        ...
        // Restricting the max display items in xaxis to MAX_CHARTS_ITEMS_IN_VIEW
    ...
    private void configureDataTable() {
        ...
        for (int i = lowestVisibleX; i <= highestVisibleX; i++) {
            Entry entry = dataSet.getEntryForIndex((int) i);
