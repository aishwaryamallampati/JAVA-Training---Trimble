...
import com.training.functions.pdf.com.wopata.boxable.ColoredColumnTable;
import com.training.functions.pdf.com.wopata.boxable.Row;
import com.training.functions.pdf.com.wopata.boxable.columns.ColoredColumn;
...
public class BoxablePdfReport implements IPdfReport {
    ...
    BoxablePdfReport(Context context) {
    ...
    /**
     *drawCircle creates a circle with the given radius.
     */
    private void drawCircle(int cx, int cy, int r, int red, int green, int blue) throws IOException {
