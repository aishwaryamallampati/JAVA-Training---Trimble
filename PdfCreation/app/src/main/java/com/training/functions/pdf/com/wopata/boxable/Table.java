...
/*
 Quodlibet.be
 */
package com.training.functions.pdf.com.wopata.boxable;
...
import com.training.functions.pdf.com.wopata.boxable.page.PageProvider;
import com.training.functions.pdf.com.wopata.boxable.text.WrappingFunction;
...
//		this.tableContentStream = createPdPageContentStream();
    ...
    public void drawTitle(String title, PDFont font, int fontSize, float tableWidth, float height, String alignment, float freeSpaceForPageBreak,
        ...
        if (title == null) {
            ...
            if (drawDebug) {
                // margin
                PDStreamUtils.rect(tableContentStream, margin, yStart, width, headerBottomMargin, ColorUtils.getColor(Color.CYAN));
            }
        }
    ...
    private void drawCellsContent(Row<T> row) throws IOException {
