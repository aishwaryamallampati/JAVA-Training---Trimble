...
public class Row<T extends PDPage> {
	 ...
	 * @return
	 */
	public Cell<T> createPercentCell(float width, String value) {
	 ...
	 * @return
	 */
	public Cell<T> createPercentCell(float width, String value, HorizontalAlignment align, VerticalAlignment valign) {
	 ...
	 * @return
	 */
	public Cell<T> createPercentCell(String value) {
